...
<label class="col-sm-2 control-label">Hos id</label>
<div class="col-sm-4">
<input type="text" name="Hos_id" class="form-control" required>
</div>
<label class="col-sm-2 control-label">Hos_name</label>
<div class="col-sm-4">
...
<div class="col-sm-4">
<input type="text" name="Hos_phno" onKeyPress="return isNumberKey(event)"  maxlength="10" class="form-control" required>
</div>
...
<div class="col-sm-10">
<textarea class="form-control" name="Btype" ></textarea>
</div></div>
